...
#let design-header-vertical-space-between-name-and-connections = 5pt
#let design-header-vertical-space-between-connections-and-first-section = 5pt
#let design-header-use-icons-for-connections = true
...
#let design-highlights-top-margin = 0.10cm
#let design-highlights-left-margin = 5pt
#let design-highlights-vertical-space-between-highlights = 0.10cm
